...
async function startnaimi() {
    const naimi = naimiConnect({
        ...
        browser: ['AnggaDev Botz Md','Safari','1.0.0'],
        auth: state,
        version: getVersionWaweb() || [2, 2204, 13]
    })
    console.log(color('[angga MD]', 'cyan'), color(`
██╗░░██╗░█████╗░██████╗░██╗░░░██╗████████╗░█████╗░
██║░██╔╝██╔══██╗██╔══██╗██║░░░██║╚══██╔══╝██╔══██╗
█████═╝░███████║██████╔╝██║░░░██║░░░██║░░░███████║
██╔═██╗░██╔══██║██╔══██╗██║░░░██║░░░██║░░░██╔══██║
██║░╚██╗██║░░██║██║░░██║╚██████╔╝░░░██║░░░██║░░██║
╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝░╚═════╝░░░░╚═╝░░░╚═╝░░╚═╝`, 'red'))
console.log(color('[ANGGA MD]', 'cyan'), color('OWNER SEDANG ONLINE SEKARANG!', 'yellow'))

	console.log(color('[ANGGA MD]', 'cyan'), color('SELAMAT DATANG OWNER ><', 'yellow'))
	
	console.log(color('======================', 'fuchsia'),color('\n[ANGGA MD V1]', 'pink'),color('\nTHANKS TO: \n➸ ALLAH SWT\n➸ Dika Ardnt.\nPenyedia scrape dan module lainnya', 'yellow'),color('\n======================', 'fuchsia'))
	console.log(color('\nADA SARAN ATAU MASUKAN WA : +6281997496643', 'red'))
    store.bind(naimi.ev)
    ...
    naimi.ev.on('messages.upsert', async chatUpdate => {
        ...
        require("./angga")(naimi, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
...
let buttonMessage = {
document: fs.readFileSync('./angga/angga.xlsx'),
mimetype: docs,
...
let buttons = [
{buttonId: `wkwwk`, buttonText: {displayText: 'ꜱᴀʏᴏɴᴀʀᴀ'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./angga/angga.xlsx'),
mimetype: docs,
...
mediaType:2,
thumbnail: ppusernya,
sourceUrl: `https://youtube.com/channel/UCY89Fb9pCVUeMqEGikvOhNQ`,
...
naimi.sendMessage(anu.id, buttonMessage, {quoted:unicorndoc})
	...
	for (let i of kon) {
	    list.push({
	    	...
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await naimi.getName(i + '@s.whatsapp.net')}\nFN:${setting.ownerName}\nORG:${setting.deskripsi};\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET:angga007ps3@gmail.com\nitem2.X-ABLabel:Email\nitem3.https://youtube.com/channel/UCY89Fb9pCVUeMqEGikvOhNQ\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;Japan;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
